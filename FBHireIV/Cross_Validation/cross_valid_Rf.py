                 ...
                 for depth in range(1,20):
                     for split in range(1,20):
                        for leaf in range(1,20):
                            for estimat in range(1,2000,10):
                                clf_RFC = RandomForestClassifier(max_depth=depth,min_samples_split=split,min_samples_leaf=leaf,n_estimators=estimat*100)
