...
def GrabData():
    ...
    file_categorical = open('./column_names/categorical_columns.csv')
    categorical_columns = file_categorical.readline().split(',')
    file_categorical.close()
    
    file_date = open('./column_names/date_columns.csv')
    #date_columns = file_date.readline().split(',')
    date_columns =  ['Id', 'L3_S30_D3496', 'L3_S30_D3506', 'L3_S30_D3501', 'L3_S30_D3516', 'L3_S30_D3511', 'L3_S32_D3852', 'L3_S33_D3856']
    file_date.close()

    file_numeric = open('./column_names/numeric_columns.csv')
