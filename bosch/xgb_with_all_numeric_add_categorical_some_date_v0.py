...
def GrabData():
    ...
    file_categorical = open('../src/column_names/categorical_columns.csv')
    categorical_columns = file_categorical.readline().split(',')
    file_categorical.close()
    
    file_date = open('../src/column_names/date_columns.csv')
    #date_columns = file_date.readline().split(',')
    date_columns =  ['Id', 'L0_S21_D514','L1_S24_D1828', 'L1_S25_D1887', 'L2_S27_D3156', 'L2_S28_D3227', 'L3_S29_D3325','L3_S30_D3496', 'L3_S30_D3506','L3_S30_D3501', 'L3_S30_D3516', 'L3_S30_D3511', 'L3_S32_D3852', 'L3_S33_D3856', 'L3_S36_D3940', 'L3_S37_D3942','L3_S43_D4092','L3_S47_D4175', 'L3_S51_D4257']
    file_date.close()

    file_numeric = open('../src/column_names/numeric_columns.csv')
    numeric_columns = file_numeric.readline().split(',')
    file_numeric.close()
    ...
    # Categorical : ['Id','L1_S24_F1559', 'L3_S32_F3851','L1_S24_F1827', 'L1_S24_F1582', 'L3_S32_F3854', 'L1_S24_F1510', 'L1_S24_F1525']
    # date : ['Id', 'L3_S30_D3496', 'L3_S30_D3506', 'L3_S30_D3501', 'L3_S30_D3516', 'L3_S30_D3511', 'L3_S32_D3852', 'L3_S33_D3856']
    # Numeric : ['Id','L1_S24_F1846', 'L3_S32_F3850', 'L1_S24_F1695', 'L1_S24_F1632','L3_S33_F3855', 'L1_S24_F1604', 'L3_S29_F3407', 'L3_S33_F3865', 'L3_S38_F3952', 'L1_S24_F1723',
    #         'Response']
    traindata = None
    testdata = None
