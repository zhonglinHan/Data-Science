...
if __name__ == '__main__':
       ...
       #enroll_data = read_csv('../data/test/enrollment_test.csv', header = 0)
       #log_data = read_csv('../data/test/log_test.csv', header = 0)
       ...
       #print df.head()
       #df.to_csv('../data/test/kddtest_countbyday_temp.csv', header = True, index = False, index_label = False)
       ...
       #addtrainfile = '../data/train/kddtrain_countbyday.csv'
       #testfile = '../data/test/kddtestall_v8.csv'
       #addtestfile = '../data/test/kddtest_countbyday.csv'
       
       #onkeys_train = 'enrollment_id'
       #onkeys_test = 'enrollment_id'
       #outfile_train = '../data/train/kddtrainall_v9.csv'
       ...
       dic_outliers = features.getOutliersAsc(['naobj','ncobj','ndate','ndobj','nnobj','npobj','nvobj','nwobj'],0.05)
